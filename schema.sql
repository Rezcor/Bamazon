...
VALUES ("Metal Gear Solid V","ENTERTAINMENT",49.95,150),
    ("DOOM","ENTERTAINMENT",59.99,200),
    ("Crate of Spam","GROCERY",24.50,50),
    ("Cool Shades","CLOTHING",75.00,5),
    ("Hurley Shirt","CLOTHING",54.25,35),
    ("Survival Knife","SPORTS & OUTDOORS",42.42,42),
    ("Bill and Ted's Excellent Adventure","ENTERTAINMENT",15.00,25),
    ("Mad Max: Fury Road","ENTERTAINMENT",25.50,57),
    ("Monster Hunter","ENTERTAINMENT",30.50,35),
    ("CandyLand","ENTERTAINMENT",19.95,23);
